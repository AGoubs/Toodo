              ...
              <div class="avatar avatar-xl position-relative">
                <div>
                  ...
                  <span class="h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                    <img src="https://soft-ui-dashboard-pro-laravel.creative-tim.com/avatars/team-1.jpg"
        ...
        <div class="card mt-4" id="basic-info">
          ...
          <div class="card-body pt-0">
            <form wire:submit.prevent="submit">
              ...
              <div class="">
                            <button type="submit"
                class="btn bg-gradient-dark btn-sm float-end mt-6 mb-0">Save changes</button>
              </div>
            </form>
          </div>
        </div>
