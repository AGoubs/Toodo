    ...
    <div class="col-12 mx-auto">
      <div class="card card-body mt-4">
        <form wire:submit.prevent="createLesson">
          ...
          <input type="text" class="form-control" id="lessonName" autofocus required wire:model="lessonName">
          {{-- @error('lesson.name') <div class="text-danger text-sm">{{ $message }}Test</div> @enderror --}}
          ...
          <input type="text" name="content" id="content" wire:model="lessonContent">
