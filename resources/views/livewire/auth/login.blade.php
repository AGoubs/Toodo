          ...
          <div class="card card-plain mt-8">
            ...
            <div class="card-body">
              <form wire:submit.prevent="login" action="#" method="POST" role="form text-left">
                <div class="mb-3">
                  ...
                  <input wire:model="email" id="email" type="email" class="form-control  @error('email') border border-danger  @enderror" placeholder="Email" aria-label="Email" aria-describedby="email-addon">
                  @error('email') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="mb-3">
                  <label for="password">{{ __('Mot de passe') }}</label>
                  <input wire:model="password" id="password" type="password" class="form-control @error('email') border border-danger  @enderror" placeholder="Mot de passe" aria-label="Password" aria-describedby="password-addon">
            ...
            <div class="card-footer text-center pt-0 px-lg-2 px-1">
              ...
              <p class="mb-4 text-sm mx-auto">
                {{ __(' Pas de compte ?') }}
                <a href="{{ route('sign-up') }}" class="text-info text-gradient font-weight-bold">{{ __('S\'inscrire') }}</a>
              </p>
            </div>
          </div>
        </div>
